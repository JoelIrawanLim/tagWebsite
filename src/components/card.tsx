...
const cardDataMedium = [
    ...
    { title: "Price war: Water", difficulty: "normal",          description: "Compete against your opponents in a price war! Attempt to find the cheapest bottled water for sale. ",    moreDetails: "Compete against your opponents in a price war. Find the cheapest version of bottled water for sale.  <br> Announce the competition publicly, with a 5 minute preparation time.  <br> All teams have 10 minutes to find the cheapest possible version for sale.  <br> It cannot be free. It cannot be sold by someone playing the game.  <br> Reward for winner: 3 “Location Off” Minutes" },
