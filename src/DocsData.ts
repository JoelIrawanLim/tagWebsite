...
export const SectionContent: ISectionContent[] = [
    ...
    },
    {
        ...
        <p>This cycle <yellow>repeats</yellow> until the game ends (4x). Failing to send the selfie within the 10 minute time limit will result in no more Location off time for the Runners (excluding "Location Off" Minutes).</p>
